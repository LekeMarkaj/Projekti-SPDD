...
def clients_add_file(request, pk):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            file.team = Team.objects.filter(created_by=request.user)[0]
            file.client_id = pk
...
def clients_detail(request, pk):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            comment.team = Team.objects.filter(created_by=request.user)[0]
...
def clients_add(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.success(request, 'The clients was created.')
